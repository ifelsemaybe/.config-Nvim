...
local lazygit = Terminal:new({cmd = "lazygit", hidden = true, direction = "horizontal", hide_numbers = true,  shade_filetypes = {}, shade_terminals = true, shading_factor = 2, start_in_insert = true, insert_mappings = true, persist_size = true, close_on_exit = true, shell = vim.o.shell})
...
vim.keymap.del("i",  "<Esc><Cmd>ToggleTerm<CR>", {})
