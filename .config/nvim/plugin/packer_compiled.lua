...
_G.packer_plugins = {
  ...
  moonfly = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/moonfly",
  ...
  ["nvim-nio"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/nvim-nio",
  ...
  ["one-small-step-for-vimkind"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/one-small-step-for-vimkind",
  ...
  ["readline.nvim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/readline.nvim",
    url = "https://github.com/assistcontrol/readline.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
